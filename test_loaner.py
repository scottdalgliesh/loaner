...
def test_validate_princ(inp, exception_raised):
    check_validation(Loan._validate_princ, inp, exception_raised)
...
def test_validate_inter(inp, exception_raised):
    check_validation(Loan._validate_inter, inp, exception_raised)
...
def test_validate_payme(inp, exception_raised):
    check_validation(Loan._validate_inter, inp, exception_raised)
...
def test_validate_start(inp, exception_raised):
